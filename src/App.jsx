  ...
  return (
    <>
      ...
      >
        ...
        <p>
          Please be careful to make sure you upload the correct photos or
          videos!
        </p>
        <p>
            For video upload, wait a couple of seconds once you tap add. The
            videos are being copied onto the preview for you to upload.
        </p>
